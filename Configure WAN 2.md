...
<img width="1340" height="496" alt="image" src="https://github.com/user-attachments/assets/7063158d-ce2c-4fa1-8b9c-a801e7b10235" />

*Вид итоговой топологии сети*

# Вывод:
В ходе выполнения данной практической работы была спроектирована и реализована комплексная корпоративная сеть, включающая настройку защищённого WAN-соединения по протоколу PPP с CHAP-аутентификацией, динамическую маршрутизацию IPv4 с применением протоколов OSPFv2 и BGP, а также полноценную интеграцию IPv6 посредством настройки OSPFv3 и EIGRPv6; кроме того, были изучены и применены на практике такие технологии, как установка и активация лицензий Cisco IOS, ретрансляция DHCP-запросов и формирование маршрута по умолчанию для обеспечения связности с внешними сетями, что позволило освоить принципы построения отказоустойчивых и безопасных сетевых инфраструктур.
